...
Example:
    >>> from dlnai.ai.prompts import get_prompt, PromptCategory
    >>>
...
if TYPE_CHECKING:
    from dlnai.core.memory import Memory
...
def _get_avg_temporal_confidence(memories: list["Memory"]) -> float:
    """Calculate average confidence for memory dates."""
    from dlnai.core.memory import ConfidenceLevel
