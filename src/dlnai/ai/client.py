...
through this client. No other file in the codebase should import google.genai or google.generativeai.
...
Example:
    >>> from dlnai.ai.client import get_client, AIUnavailableError
    >>>
    >>> try:
    ...     client = get_client()
...
try:
    ...
    GenAIClientError = None  # type: ignore
    google_exceptions = None  # type: ignore
    GENAI_AVAILABLE = False

# Type checking imports
if TYPE_CHECKING:
    from dlnai.ai.usage_tracker import UsageTracker
...
class AIClient:
    ...
    def __init__(
        ...
        try:
            ...
            self._logger.info(f"AI V2 client configured with default narrative model: {self._config.ai.narrative_model}")
    ...
    def _get_generation_config(self, system_instruction: str | None = None, **overrides: Any) -> types.GenerateContentConfig:
        """Build GenerateContentConfig from settings with optional overrides.
        ...
        """
        # Safety settings balanced for life story analysis
        safety_settings = [
            types.SafetySetting(
        ...
        return types.GenerateContentConfig(
            temperature=overrides.get("temperature", self._config.ai.temperature),
            max_output_tokens=overrides.get("max_output_tokens", self._config.ai.max_output_tokens),
    ...
    def generate(
        ...
        **overrides: Any,
        ...
        """Generate text from a prompt or multimodal parts using V2 SDK.
        ...
        try:
            ...
            raise ContentBlockedError(
                blocked_reason="Response blocked or empty. Check for safety filters."
            )
    ...
    def _do_generate(
        ...
        """Execute the actual API call using V2 SDK.
    ...
    def count_tokens(self, text: str, model: str | None = None) -> int:
        """Count tokens for text using the V2 SDK.
        ...
        try:
            target_model = model or self._config.ai.narrative_model
