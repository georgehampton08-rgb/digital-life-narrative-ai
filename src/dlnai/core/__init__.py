...
Example:
    >>> from dlnai.core import Memory, MediaType, SourcePlatform
    >>> from dlnai.core import PrivacyGate, PrivacyLevel
    >>> from dlnai.core import Timeline, TimelineQuality
    >>>
    >>> # Create memories
    >>> memory = Memory(
...
from dlnai.core.privacy import (
    ConsentReceipt,
...
from dlnai.core.timeline import (
    DateRange,
    PlatformActivity,
    TimeGranularity,
    Timeline,
