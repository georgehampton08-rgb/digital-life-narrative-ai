...
Example:
    >>> from dlnai.core.privacy import PrivacyGate, PrivacyLevel, PrivacySettings
    >>>
...
from dlnai.core.models import Location, Memory, PersonTag
...
def get_default_gate() -> PrivacyGate:
    ...
    Example:
        >>> from dlnai.core.privacy import get_default_gate
