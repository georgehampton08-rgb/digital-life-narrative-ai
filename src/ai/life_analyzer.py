...
WARNING: Please migrate your imports to `src.ai` as this file will be 
removed in v1.1.
...
warnings.warn(
    "src.ai.life_analyzer is deprecated and will be removed in v1.1. "
    "Please migrate to src.ai (LifeStoryAnalyzer) or src.ai.analyzer.",
    DeprecationWarning,
    stacklevel=2
)

logger = logging.getLogger(__name__)
logger.warning("DEPRECATION: src.ai.life_analyzer is being used. Switch to src.ai.")
...
def estimate_visual_cost(
    ...
    """
    from src.config import get_config, DEPTH_MODE_CONFIGS, STANDARD_MODE_CONFIG
