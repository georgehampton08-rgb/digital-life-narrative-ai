...
class Memory(BaseModel):
    ...
    def to_timeline_point(self) -> dict:
        ...
        return {
            ...
            "media_type": self.media_type.value,
            "has_location": (self.location is not None and not self.location.is_empty()),
    ...
    def is_same_moment(self, other: "Memory", tolerance_seconds: int = 60) -> bool:
        ...
        if (
            ...
            distance = self.location.coordinates.distance_km(other.location.coordinates)
    ...
    def merge_with(self, other: "Memory") -> "Memory":
        ...
        for person in self.people + other.people:
            ...
            if (
                ...
                or confidence_rank[person.confidence] > confidence_rank[people_dict[key].confidence]
            ):
        ...
        merged_data["parse_warnings"] = list(set(self.parse_warnings + other.parse_warnings))
    ...
    def from_dict(cls, data: dict) -> "Memory":
        ...
        if "location" in data and isinstance(data["location"], dict):
            ...
            if "coordinates" in data["location"] and isinstance(
                ...
                data["location"]["coordinates"] = GeoPoint(**data["location"]["coordinates"])
